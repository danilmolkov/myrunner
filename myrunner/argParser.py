...
def parse():
    ...
    parser.add_argument('-i', '--interactive', dest='interactive', action='store_true',
                        help='(experimental!) ask interactively about running and environment variables')

    group = parser.add_argument_group('other')
    group.add_argument('--completion', dest='completion', action='store_true',
                       help='print autocompletion script. Use: source <(myrunner --completion) (add this to ~/.bashrc)')
